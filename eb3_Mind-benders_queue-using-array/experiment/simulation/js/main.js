function main(){
    ...
    var algo = {
        ...
        colorCode: [{key:'Main', color:'grey'},
                    ...
                    {5} int Set_B[7];
                    {5} union_of_Set[14];
                    {5} int i,j,k,n,m,flag;
                  /* Enter element of Set A */
                  {5} printf("Enter size of Set_A:");
                  {5} scanf("%d",&n);
                  {5} for(i=0;i<n;++i){
                          {5} printf("Enter elements of Set_A:");
                          {5} scanf("%d",&Set_A[i]);
                  {5} }
                  /* Enter element of Set B */
                  {5} printf("Enter size of Set_B:");
                  {5} scanf("%d",&n);
                  {5} printf("Enter elements of Set_B:");
                  {5} for(i=0;i<n;++i){
                          {5} scanf("%d",&Set_A[i]);
                  {5} }
          
                  /* Loop to check the sets */
                  {5} k=0;  /* initialize k as 0 */
                  {5} for(i=0;i<n;++i){
                          {5} u[k]=a1[i];
                          {5} k++; /* Increment K */
                  {5} }
                  ...
                  /* Display */
                  {5} printf("Union of two arrays is:");
                  {5} for(i=0;i<k;++i){
                          {5} printf("%d ",u[i]);
                  {5} }
                  {2} return 0;
